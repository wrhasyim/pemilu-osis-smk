...
<div class="bg-white p-8 rounded-lg shadow-lg max-w-2xl mx-auto">
   ...
   <div class="mb-6 p-4 bg-blue-100 border-l-4 border-blue-500 text-blue-700">
    ...
    <li>Unduh dan gunakan file sampel untuk format yang benar.</li>
    <li>Kolom wajib diisi: <strong>nama</strong>, <strong>nis</strong>, dan <strong>kelas</strong>.</li>
    <li>Kolom <strong>password</strong> bersifat opsional.</li>
    <li>Jika kolom password dikosongkan, password default akan digunakan: <strong>12345678</strong>.</li>
</ul>
